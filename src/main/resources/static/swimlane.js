...
const swimlaneData = [
  ...
  { name: "Task A", lane: "Team 4", start: new Date(2024, 9, 1, 10, 0), end: new Date(2024, 9, 1, 10, 30) },
  { name: "Task B", lane: "Team 5", start: new Date(2024, 9, 1, 10, 45), end: new Date(2024, 9, 1, 11, 15) },
  { name: "Task C", lane: "Team 6", start: new Date(2024, 9, 1, 10, 10), end: new Date(2024, 9, 1, 11, 0) },
  { name: "Task D", lane: "Team 7", start: new Date(2024, 9, 1, 11, 5), end: new Date(2024, 9, 1, 11, 45) },
  { name: "Task E", lane: "Team 3", start: new Date(2024, 9, 1, 10, 20), end: new Date(2024, 9, 1, 11, 10) },
  { name: "Task A", lane: "Team 21", start: new Date(2024, 9, 1, 10, 0), end: new Date(2024, 9, 1, 10, 30) },
  { name: "Task B", lane: "Team 21", start: new Date(2024, 9, 1, 10, 45), end: new Date(2024, 9, 1, 11, 15) },
  { name: "Task C", lane: "Team 42", start: new Date(2024, 9, 1, 10, 10), end: new Date(2024, 9, 1, 11, 0) },
  { name: "Task D", lane: "Team 24", start: new Date(2024, 9, 1, 11, 5), end: new Date(2024, 9, 1, 11, 45) },
  { name: "Task E", lane: "Team 3", start: new Date(2024, 9, 1, 10, 20), end: new Date(2024, 9, 1, 11, 10) }
];
...
// Add click anywhere else to hide the tooltip
